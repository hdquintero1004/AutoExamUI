...
class TeachersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create teacher" do
    assert_difference('Teacher.count') do
      post teachers_url, params: { teacher: { signature_id: @teacher.signature_id, user_id: @teacher.user_id } }
    end
  ...
  test "should update teacher" do
    patch teacher_url(@teacher), params: { teacher: { signature_id: @teacher.signature_id, user_id: @teacher.user_id } }
