...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post options_url, params: { option: { body: @option.body, question_id: @option.question_id, true_or_false: @option.true_or_false } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { body: @option.body, question_id: @option.question_id, true_or_false: @option.true_or_false } }
