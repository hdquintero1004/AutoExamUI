...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post exams_url, params: { exam: { description: @exam.description, signature_id: @exam.signature_id, title: @exam.title } }
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { description: @exam.description, signature_id: @exam.signature_id, title: @exam.title } }
